...
<div class="container">
    ...
    <p>
        If the lack of this tool has reduced your ability to play or your enjoyment of Elite: Dangerous then please let Frontier know at
        <a href="">the Elite: Dangerous forum thread</a>
        or
        <a href="">the Reddit post</a>
        . The more players who share their stories, the more Frontier will be able to see the value of supporting the third-party development community which has brought you this tool and so many others.
    </p>
    <p>
    ...
    <p>
        The following sites are offline for the duration of this message:
    </p>
    <ul>
        <li>
            <a href="https://captainslog.scarygliders.net/">
                Captain's Log
            </a>
        </li>
        <li>
            <a href="https://coriolis.edcd.io/">
                Coriolis EDCD Edition
            </a>
        </li>
        <li>
            <a href="http://en.ed-board.net/">
                ED-Board
            </a>
        </li>
        <li>
            <a href="http://edcodex.info/">
                Elite: Dangerous Codex
            </a>
        </li>
        <li>
            <a href="https://eddb.io/">
                Elite: Dangerous Database (EDDB)
            </a>

        </li>
        <li>
            <a href="http://www.edshipyard.com/">
                E:D Shipyard
            </a>
        </li>
        <li>
            <a href="https://www.edsm.net/">Elite: Dangerous Star Map (EDSM)</a> (Please note that our API are still available)
        </li>
        <li>
            <a href="https://inara.cz/">
                INARA
            </a>
        </li>
    </ul>
    <p>
        In addition, the authors of the following apps support this message:
    </p>
    <ul>
        <li>
            <a href="https://forums.frontier.co.uk/showthread.php/226649-EDDI-A(nother)-Voice-Attack-Plugin">
                Elite Dangerous Data Interface (EDDI)
            </a>
        </li>
        <li>
            <a href="https://forums.frontier.co.uk/showthread.php?t=225287">
                Elite: Dangerous Market Connector (EDMC)
            </a>
        </li>
        <li>
            <a href="https://bitbucket.org/Esvandiary/edts">
                Elite: Dangerous Travel Scripts (EDTS)
            </a>
        </li>
    </ul>
